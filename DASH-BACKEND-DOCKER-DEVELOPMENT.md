...
# Set to the path of the domain module on the host (e.g. ../kitchntabs-backend-domain)
...
| `Domain` | `./domain/tests` | Tests loaded from the mounted `${DOMAIN_PATH}` (e.g. `../kitchntabs-backend-domain/tests/`). |
